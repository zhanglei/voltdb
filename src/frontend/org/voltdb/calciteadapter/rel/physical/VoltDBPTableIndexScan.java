...
public class VoltDBPTableIndexScan extends AbstractVoltDBPTableScan {
    ...
    public double estimateRowCount(RelMetadataQuery mq) {
        ...
        if (m_index.getUnique() && (colCount == keyWidth)) {
            ...
            tuplesToRead += (int) (AbstractVoltDBPTableScan.MAX_TABLE_ROW_COUNT * 0.90 * Math.pow(0.10, keyWidth));
